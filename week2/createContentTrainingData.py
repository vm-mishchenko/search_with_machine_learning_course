...
directory = r'/Users/vitalii.mishchenko/Documents/personal/opensearch/data/product_data/products'
output = r'/Users/vitalii.mishchenko/Documents/personal/opensearch/data/fasttext/labeled_products.txt'

parser = argparse.ArgumentParser(description='Process some integers.')
general = parser.add_argument_group("general")
general.add_argument("--input", default=directory,  help="The directory containing product data")
general.add_argument("--output", default=output, help="the file to output to")
